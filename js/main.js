...
//	menu.save.addEventListener('touchend', onMenuSave, false);
        /*setTimeout(function() {
            menu.exportImage.trigger('click')     .addEventListener('click', onMenuExportImage, false);
        }, 60000);*/
...
//	menu.about.addEventListener('touchend', onMenuAbout, false);
	...
	container.appendChild(menu.container);
        ...
        var begin = setInterval(function() {
            if (timer.minute.innerHTML === '1' && timer.seconds.innerHTML === '00') {
                timer.minute.innerHTML = '0';
                timer.seconds.innerHTML = '59';
                clearInterval(begin);
            }
        }, 1000);
        ...
        setTimeout(function() {
            var int = setInterval(function() {
                ...
                if (timer.minute.innerHTML === '0' && timer.seconds.innerHTML === '00') {
                    clearInterval(int);
